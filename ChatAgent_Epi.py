        ...
        store[session_id]["prompt"] = ChatPromptTemplate.from_messages(
            [
                (
                    ...
                    - Don't never mention roles directly. Persona-based personality traits, new episodes they may have experienced, can be mentioned directly at a level that doesn't interrupt with the conversation.
