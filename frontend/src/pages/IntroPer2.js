...
const IntroPer1 = () => {
  ...
  // const handleStart = () => {
  //   navigate(`/chat2/1?participantId=${participantId}`);
  // };
  ...
  return (
    <div className="page-container">
      <div className="fixed-shape">
        <span>자기 페르소나와 대화 경험 평가 >> 주제 선택 >> 채팅 및 경험 평가1 >> 페르소나 평가1 >> </span> 
        <p>&nbsp; 채팅 및 경험 평가2</p> 
      </div>
      ...
      <div className="topic-container">
        <section className="experiment-procedure">
          ...
          <p>&nbsp;</p>
          <p>&nbsp;</p>
          <p style={{ fontSize: "25px", textAlign: "center" }}>✌️ 두번째 페르소나와 채팅</p>
          <p>&nbsp;</p>
          <img
          src="chat.png"
          alt="실험 절차"
        ...
        />
          ...
          <p style={{ fontSize: "13px", textAlign: "center" }}>
            이 단계에서는 <strong>두번째 페르소나</strong>와 <strong>10개</strong>의 주제로 대화를 하게 됩니다.
          </p>
          <p style={{ fontSize: "13px", textAlign: "center" }}>
            각 대화가 끝난 후에 <strong>대화 경험을 평가</strong>하고, 10번의 대화가 끝난 후엔 두번째 <strong>페르소나를 평가</strong>하게 됩니다.
          </p>
          <p style={{ fontSize: "13px", textAlign: "center" }}>
